...
<div class="m-3">
    ...
    <form action="/tryout/{{$tryout->id}}/soaltryout/{{$questions->id}}" method="post" enctype="multipart/form-data">
        ...
        <p>Pilihan A</p>
        <div class="mt-2">
            @if (substr($questions->option_a, -3) === 'png' || substr($questions->option_a, -3) === 'jpg' || substr($questions->option_a, -3) === 'peg')
                <p>Gambar saat ini</p>
                ...
                <input class="form-control" type="file" id="g_option_a" name="new_g_option_a" onchange=previewImageA()>
            @else
        ...
        <div class="mt-2">
            @if (substr($questions->option_b, -3) === 'png' || substr($questions->option_b, -3) === 'jpg' || substr($questions->option_b, -3) === 'peg')
                <p>Gambar saat ini</p>
                ...
                <input class="form-control" type="file" id="g_option_b" name="new_g_option_b" onchange=previewImageB()>
            @else
            <label for="option_b">Teks</label>
            <input id="a" type="hidden" name="option_b" value="{{ old('option_b', $questions->option_b) }}">
            <trix-editor input="a"></trix-editor>
            <div class="mt-3 mb-5">
        ...
        <div class="mt-2">
            @if (substr($questions->option_c, -3) === 'png' || substr($questions->option_c, -3) === 'jpg' || substr($questions->option_c, -3) === 'peg')
                <p>Gambar saat ini</p>
                ...
                <input class="form-control" type="file" id="g_option_c" name="new_g_option_c" onchange=previewImageC()>
            @else
            <label for="option_c">Teks</label>
            <input id="a" type="hidden" name="option_c" value="{{ old('option_c', $questions->option_c) }}">
            <trix-editor input="a"></trix-editor>
            <div class="mt-3 mb-5">
        ...
        <div class="mt-2">
            @if (substr($questions->option_d, -3) === 'png' || substr($questions->option_d, -3) === 'jpg' || substr($questions->option_d, -3) === 'peg')
                <p>Gambar saat ini</p>
                ...
                <input class="form-control" type="file" id="g_option_d" name="new_g_option_d" onchange=previewImageD()>
            @else
            <label for="option_d">Teks</label>
            <input id="a" type="hidden" name="option_d" value="{{ old('option_d', $questions->option_d) }}">
            <trix-editor input="a"></trix-editor>
            <div class="mt-3 mb-5">
        ...
        <div class="mt-2 mb-5">
            @if (substr($questions->option_e, -3) === 'png' || substr($questions->option_e, -3) === 'jpg' || substr($questions->option_e, -3) === 'peg')
                <p>Gambar saat ini</p>
                ...
                <input class="form-control" type="file" id="g_option_e" name="new_g_option_e" onchange=previewImageE()>
            @else
            <label for="option_e">Teks</label>
            <input id="a" type="hidden" name="option_e" value="{{ old('option_e', $questions->option_e) }}">
            <trix-editor input="a"></trix-editor>
            <div class="mt-3 mb-5">
